...
- (void) initialize
{
    ...
    //dsy changed
    self.captionBackgroundColor = [UIColor grayColor];
    self.captionTextColor = [UIColor whiteColor];
    self.captionFont = [UIFont fontWithName:@"Helvetica-Light" size:20.0f];
...
{
    _captionLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 150, _scrollView.frame.size.width, 50)];
