...
@interface LinZhanDetailVC ()

@end

@implementation LinZhanDetailVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self setupNavBtnWithTitle:@"临展活动"];
...
-(void) startRequestTemp{//////临展
    ...
    DataRequest *request = [QyDataManger getLinZhanInfoWithStartdate:_selectItem.entityId callback:^(TemporaryDisplay *td, BOOL success) {
        ...
        temp = [NSString stringWithFormat:@"展期 %@到%@",items.exhibitionDate,items.exhibitionEndDate];
        _zhanquLabel.text = temp;
