...
@property (weak, nonatomic) NSString *titleImageName;
...
- (void)awakeFromNib {
    ...
    flowLayout.itemSize = CGSizeMake(150.0, 122.0);
...
- (void) setTitleImageName:(NSString *)titleImageName{
    _titleView.image = [UIImage imageNamed:titleImageName];
    //[_titleView sd_setImageWithURL:[NSURL URLWithString:titleImageName]];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //dsy comment;
    [cell.blockImage sd_setImageWithURL:[NSURL URLWithString:cellData[@"image"]]];
    return cell;
}
