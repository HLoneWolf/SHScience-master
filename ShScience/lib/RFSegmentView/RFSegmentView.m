...
-(void)setNorColor:(UIColor *) norColor {
    NSLog(@"start set norClor");
}

-(void) setSegementItemNorColor:(UIColor *) segementItemNorColor {
    NSLog(@"start set segementItemNorColor");
    for (NSInteger i = 0; i<self.items.count; i++) {
        RFSegmentItem *item = self.items[i];
        item.norColor = segementItemNorColor;
    }
}

-(void) setSegementItemSelColor:(UIColor *) segementItemSelColor{
    NSLog(@"start set segementItemSelColor");
    for (NSInteger i = 0; i<self.items.count; i++) {
        RFSegmentItem *item = self.items[i];
        item.selColor = segementItemSelColor;
    }
